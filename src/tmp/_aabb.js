/**
 * https://github.com/chrisdickinson/aabb-2d
 */
...
proto.union = function (aabb) {
  ...
  var base_y = Math.max(aabb.base[1], this.base[1])

  var max_x = Math.min(aabb.max[0], this.max[0])

  var max_y = Math.min(aabb.max[1], this.max[1])
